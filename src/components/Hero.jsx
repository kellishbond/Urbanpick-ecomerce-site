...
//                     <p className='font-meduim text-sm md:text-based' >OUR BESTSELLERS</p>
//                 </div>
//                 <h1 className='prata-regular text-3xl sm:py3 lg:text-5xl leading-relaxed'>New Additions</h1>
//                 <div className='flex items-center gap-2'>
